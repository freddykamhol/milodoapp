...
import { PersonalfragebogenMinijobClient } from "./personalfragebogen-minijob-client";

export default function PersonalfragebogenMinijobPage() {
  return (
    <main className="min-h-dvh px-4 py-8 sm:px-6 sm:py-10">
      <div className="mx-auto w-full max-w-4xl">
          ...
          <div className="flex items-center gap-3">
            ...
            <div className="min-w-0">
              ...
              <h1 className="truncate text-xl font-semibold tracking-tight sm:text-2xl">
                Personalfragebogen GfB / Minijob
              </h1>
            </div>
          </div>
        ...
        <div className="rounded-3xl border border-[var(--border)] bg-white p-4 shadow-[var(--shadow)] sm:p-6">
          ...
          <div className="mt-6">
            <PersonalfragebogenMinijobClient />
          </div>
        </div>
      </div>
    </main>
